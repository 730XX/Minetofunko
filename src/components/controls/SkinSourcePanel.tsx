...
import { Search, RotateCw, UploadCloud, User, FileImage, History, Sparkles } from 'lucide-react';
    ...
    <div className="flex flex-col gap-4">
      ...
      {tab === 'username' ? (
          ...
          <form onSubmit={(e) => handleFetch(e)} className="flex items-center gap-2">
            <div className="relative flex-1 flex items-center">
              ...
              <input
                ...
                placeholder="Ingresá nick de Minecraft..."
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {recentSearches.map((name) => (
                  <button
                    ...
                    className="flex items-center gap-2 p-1.5 rounded-lg bg-[#121620] hover:bg-[#262a34] border border-[#262a34] hover:border-[#4edea3]/40 transition-all text-left cursor-pointer group"
                  >
                    <img
                      ...
                      onError={(e) => {
                        // Fallback simple si falla avatar
        ...
        >
          ...
          <p className="text-xs font-semibold text-[#dfe2ef]">Arrastrá o hacé clic para subir tu skin</p>
